...
export default function Checkout() {
    ...
    const totalAmount = Math.round(items.reduce((amount, item) => item.price * item.quantity + amount, 0) * 100) / 100
            ...
            <div className="mx-auto max-w-7xl px-4 mt-12 bg-white py-6 sm:px-6 lg:px-8">
                <div className="grid grid-col-span-1 gap-x-8 gap-y-8 lg:grid-cols-5">
                            ...
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <ul role="list" className="divide-y divide-gray-100">
                                    {user.addresses.map((address, index) => (
                                        <li
                                            key={index}
                                            className="flex justify-between gap-x-6 py-5 px-5 border-solid border-2 border-grey-200">
                                ...
                                <div className="mt-10 space-y-10">
                                    <fieldset>
                                        ...
                                        <p className="mt-1 text-sm leading-6 text-gray-600">Choose your Payment Method:</p>
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="mx-auto max-w-7xl px-4 mt-12 bg-white py-2 sm:px-2 lg:px-2">
